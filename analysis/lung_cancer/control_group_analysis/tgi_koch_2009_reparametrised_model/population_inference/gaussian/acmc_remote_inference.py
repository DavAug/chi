...
n_chains = 5
n_initial_phase_iterations = 1000 * problem.get_n_parameters()
n_iterations = 1250000  # Comparable # func evals to NUTS
logging_steps = 1000
sampler = pints.HaarioBardenetACMC
...
controller.set_initial_phase_iterations(
    iterations=n_initial_phase_iterations)
